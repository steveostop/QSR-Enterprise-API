 ...
 * @property {string} ConsumerQuoteString - 
 * @property {GuestAddress[]} Addresses - 
 * @property {GuestCustomValue[]} CustomValues - 
 * @property {string} Email - 
 * @property {string} FirstName - 
 * @property {string} ID - 
 * @property {boolean} IsAnonymous - 
 * @property {boolean} IsSubscribedToEmailMarketing - 
 * @property {boolean} IsSubscribedToQsrMarketing - 
 * @property {boolean} IsSubscribedtoSmsMarketing - 
 * @property {string} LastName - 
 * @property {GuestLoyalty} Loyalty - 
 * @property {string} Notes - 
 * @property {GuestPhoneNumber[]} PhoneNumbers - 
